# Support for Output Descriptors in LiteNote Core

Since LiteNote Core v0.17, there is support for Output Descriptors in the
...
on LiteNote's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing LiteNote Core wallets, a convenience function `combo` is
