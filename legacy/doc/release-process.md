...
Add other gitian builders keys to your gpg keyring, and/or refresh keys: See `../litenote/contrib/gitian-keys/README.md`.
...
space *do not upload these to the litenote.org server, nor put them in the torrent*.
