...
* litenote.conf: contains configuration settings for litenoted or litenote-qt
* litenoted.pid: stores the process id of litenoted while running
...
* debug.log: contains debug information and general logging generated by litenoted or litenote-qt
