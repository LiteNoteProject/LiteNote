...
// Copyright (c) 2019 Ronsor Labs, et al.
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php
#define GB_HASH "0xdd18e0c0db2ac042add4fc3a012c1c6a49cd6b968d81e7c3c9d830a1f0ab4c36"
#define GB_TS 1560898498
#define GB_NONCE 2084820402
#define GB_BITS 0x207fffff
#define MR_HASH "0x28147047e3473e608dfe4098149a12b9ed82492ad303135af4c94ba15d38282c"
#define REWARD 2500000
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 960000;
        ...
        consensus.powLimit = uint256S("000effffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); 
        consensus.premineLimit = uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); 
        consensus.nPowTargetTimespan = 2.5 * 24 * 60 * 60; // 1.4 days
        consensus.nPowTargetSpacing = 2.5 * 60;
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.fPowNoRetargeting = false;
        consensus.nRuleChangeActivationThreshold = 3; // 75% of 8064
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = 9517356801; // January 31st, 2018
        ...
        consensus.nMinimumChainWork = uint256S("0x00000000000000000000000000000");
        ...
        genesis = CreateGenesisBlock(GB_TS, GB_NONCE, GB_BITS ? GB_BITS : 0x1e0ffff0, 1, REWARD * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        if(consensus.hashGenesisBlock != uint256S(GB_HASH)) {
		std::cout << "ERROR MISMATCH " GB_HASH "\nERROR MISMATCH " << consensus.hashGenesisBlock.GetHex() << "\n";
		abort();
	}
        assert(genesis.hashMerkleRoot == uint256S(MR_HASH));
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(GB_TS, GB_NONCE, GB_BITS ? GB_BITS : 0x1e0ffff0, 1, REWARD * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S(GB_HASH));
        assert(genesis.hashMerkleRoot == uint256S(MR_HASH));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.litenote.ronsor.pw");
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x88, 0x35, 0x87, 0xCF};
        base58Prefixes[EXT_SECRET_KEY] = {0x37, 0x35, 0x83, 0x94};
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1296688602, 0, 0x207fffff, 1, REWARD * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
