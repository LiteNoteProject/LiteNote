...
const QString BITCOIN_IPC_PREFIX("litenote:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/litenote-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/litenote-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/litenote-paymentrequest";
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(0, tr("Payment request error"),
                tr("Cannot start litenote: click-to-pay handler"));
        }
        else {
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("litenote://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'litenote://' is not a valid URI. Use 'litenote:' instead."),
    ...
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        else // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                Q_EMIT message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid LiteNote address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
