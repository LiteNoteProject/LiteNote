...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " litenote-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  litenote-tx [options] <hex-tx> [commands]  Update hex-encoded litenote transaction\n" +
            "or:     litenote-tx [options] -create [commands]   Create hex-encoded litenote transaction\n" +
            "\n";
