...
"""Verify that starting litenote with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start litenote with -h for help text")
        ...
        self.log.info("Start litenote with -version for version information")
        ...
        self.log.info("Start litenoted with -fakearg to make sure it does not start")
